 ...
 */
public class ImageMap extends MouseAdapter implements State {
    public ImageMap() {
    }
    ...
    public static final NewPlaceState NEW_PLACE_STATE = new NewPlaceState();
    public static final SelectPlacesState SELECT_PLACE_STATE = new SelectPlacesState();
